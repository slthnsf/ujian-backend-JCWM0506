CREATE DATABASE  IF NOT EXISTS `backend_2021` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `backend_2021`;
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: backend_2021
-- ------------------------------------------------------
...
CREATE TABLE `movies` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(85) COLLATE utf8mb4_general_ci NOT NULL,
  `release_date` int NOT NULL,
  `release_month` int NOT NULL,
  `release_year` int NOT NULL,
  `duration_min` int NOT NULL,
  `genre` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `description` varchar(425) COLLATE utf8mb4_general_ci NOT NULL,
  `status` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_movie_status_idx` (`status`),
  CONSTRAINT `fk_movie_status` FOREIGN KEY (`status`) REFERENCES `movie_status` (`id`)
...
INSERT INTO `schedules` VALUES (1,1,1,3),(2,1,1,4),(3,1,1,5),(4,1,2,1),(5,1,2,5),(6,1,2,6),(7,1,3,1),(8,1,3,2),(9,1,3,3),(10,2,2,2),(11,2,2,4),(12,2,2,6),(13,3,1,3),(14,3,3,5),(15,3,3,6),(16,4,1,1),(17,4,2,2),(18,4,2,4),(19,4,3,3),(20,5,1,5),(21,5,2,5),(22,5,3,5),(23,6,1,1),(24,6,2,2),(25,6,3,3),(26,8,1,4),(27,8,1,6),(28,9,1,1),(29,9,1,2),(31,9,1,3),(32,10,2,5),(33,11,2,6),(34,11,1,3);
...
INSERT INTO `users` VALUES (2,'16238979','jennie','jennie@mail.com','!jen123',1,1),(3,'16238980','Lalisa','lisa@mail.com','!lisa123',2,3),(4,'16239050','Bambii','bamb@mail.com','!bambi123',2,1);
...
-- Dump completed on 2021-06-17 12:35:54
